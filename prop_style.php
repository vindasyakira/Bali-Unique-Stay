...
if (empty($_GET['ps_id'])) die("No propstyle id detected");
$ps_id = $_GET['ps_id'];
$q = "select * from property where prop_style=$ps_id";
...
$q = "select ps_name from propstyle where ps_id='$ps_id'";
...
<html lang="en">
  ...
  <body>
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-4"><?php echo $ps_name; ?></h1>
          <p>Here are the list that we have made for you to choose during your stay at <?php echo $ps_name; ?>!</p>
        </div>
      </div>
